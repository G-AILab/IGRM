...
def MAR_mask(
    ...
    coeffs = pick_coeffs(X, list(idxs_obs), list(idxs_nas))
...
def simulate_nan(
    ...
    Args:
        ...
        opt: For mecha = "MNAR", it indicates how the missing-data mechanism is generated: using a logistic regression ("logistic"),
                     a quantile censorship ("quantile")  or logistic regression for generating a self-masked MNAR mechanism ("selfmasked").
